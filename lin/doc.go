...
//
// This package's exact register/request byte layout (Config's field
// order/widths) has not yet been independently re-verified against the
...
// server/doc.go, and i2c/doc.go document for their own packages; see the
