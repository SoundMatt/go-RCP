...
// TestKind_Priority checks the cross-type ordering documented on
// priorityRank, transcribed from spec §12.9.2: cancellation < triggered <
// timed < compound < compound-wait < chained < standard/plain (REQ-REQ-002).
