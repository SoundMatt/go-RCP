...
// run first. This ordering has been verified against the RC Server request-
// handling chapter of the OPEN Alliance TC18 Remote Control Protocol
// Specification v0.5.1_RC and is a direct transcription of that chapter's
// execution-priority table, replacing this package's earlier
// self-disclosed, unverified default:
//
...
//  5. CompoundWait, the sequencer-gated, read-only condition check.
