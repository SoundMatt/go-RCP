...
// heartbeat cadence (server.QueueConfig.HeartbeatIntervalMillis,
// server/queues.go, ROADMAP.md Milestone 45): the smallest gap a caller
...
func DeadlineForQueue(q server.QueueConfig, missedHeartbeats int) (time.Duration, error) {
